...
%>	
	javastr=javastr+"<img src=https://www.luogu.org/space/show?uid=124918.com/co/images/0.gif\" border=0></img>
<%
next 

for i=1 to soonhostcomlen
%>
	javastr=javastr+"<img src=http://www.您的网址.com/co/images/<%=mid(count,i,1)%>.gif\ border=0></img>"
<%
next 
%>
